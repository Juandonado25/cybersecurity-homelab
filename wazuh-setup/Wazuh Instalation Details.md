...
Ademas tambien se mapearon los archivos de logs locales a dentro del contenedor para que Wazuh pudiera leerlos.
...
    volumes:
      - /var/log/pfsense.log:/var/ossec/logs/pfsense.log:ro
      - /var/log/suricata-eve.log:/var/ossec/logs/suricata-eve.log:ro
...
  host`s: ['https://wazuh.indexer:9200']
  ssl.enabled: true
...
    <localfile>/var/ossec/logs/pfsense.log</localfile>
  </localfile>
  
  <localfile>
    <log_format>json</log_format>
    <localfile>/var/ossec/logs/suricata-eve.log</localfile>
  </localfile>
  ```
